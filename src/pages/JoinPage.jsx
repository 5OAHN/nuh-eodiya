...
import { fetchRoom } from '../lib/roomService'
  ...
  const handleJoin = async () => {
    ...
    try {
      if (isSupabaseReady() && roomId !== 'input') {
        ...
        // initRoom 내부에서 saveSession 자동 호출
        initRoom(
          {
        ...
        <div className="fixed inset-0 z-50 flex items-end bg-black/40 backdrop-blur-sm">
          <div className="w-full max-w-[430px] mx-auto bg-white rounded-t-3xl p-6 animate-slide-up border-t border-neutral-200 shadow-xl">
            <div className="text-center mb-5">
              <div className="w-16 h-16 bg-mcm-blue-light rounded-full mx-auto mb-4 flex items-center justify-center text-3xl shadow-md">📍</div>
